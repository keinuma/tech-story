...
func (ec *executionContext) unmarshalInputNewMatch(ctx context.Context, obj interface{}) (request.NewMatch, error) {
	...
	for k, v := range asMap {
		...
		case "attendees":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("attendees"))
...
func (ec *executionContext) unmarshalInputNewUser(ctx context.Context, obj interface{}) (request.NewUser, error) {
	...
	for k, v := range asMap {
		...
		case "uuid":
			...
			ctx := graphql.WithFieldInputContext(ctx, graphql.NewFieldInputWithField("uuid"))
